...
const byte HC12RxdPin = 7;                // "RXD" Pin on HC12
const byte HC12TxdPin = 8;                // "TXD" Pin on HC12
const byte HC12SetPin = 9;                // "SET" Pin on HC12
const byte  GPSTxdPin = 3;                // "TXD" on GPS (if available)
const byte  GPSRxdPin = 2;                // "RXD" on GPS
